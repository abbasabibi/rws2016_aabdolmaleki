 ...
 */
namespace rws2016_aabdolmaleki
{
   ...
   class MyPlayer: public Player
   {
           ...
           MyPlayer(string name, string team): Player(name)
       {
           ...
           *_sub = node.subscribe("/game_move", 1, &MyPlayer::moveCallback, this);
           ...
           double getDistanceOfClosestHunter(void)
           {
           ...
           double getDistanceOfClosestPrey(void)
            {
                double prey_dist = getDistance(*prey_team->players[0]);
                string prey_name = prey_team->players[0]->name;
...
} //end of namespace rws2016_aabdolmaleki
...
int main(int argc, char** argv)
{
    ...
    ros::init(argc, argv, "aabdolmaleki");
    ros::NodeHandle node;

    //Creating an instance of class MyPlayer
    rws2016_aabdolmaleki::MyPlayer my_player("aabdolmaleki", "red");
